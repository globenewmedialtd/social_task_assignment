...
namespace Drupal\social_task_assignment_vbo\Plugin\views\field;
...
/**
 * Defines the Assignments Views Bulk Operations field plugin.
 *
 * @ingroup views_field_handlers
 *
 * @ViewsField("social_views_bulk_operations_bulk_form_assignment_source")
 */
class SocialTaskAssignmentVboMemberSelectViewsBulkOperationsBulkForm extends ViewsBulkOperationsBulkForm {
  ...
  /**
   * Constructs a new SocialTaskAssignmentVboViewsBulkOperationsBulkForm object.
   *
  ...
  public function getBulkOptions() {
    ...
    if ($this->view->id() !== 'task_assignment_selection_source') {
      return $bulk_options;
    }
  ...
  public function viewsForm(array &$form, FormStateInterface $form_state) {
    ...
    $form['header']['social_views_bulk_operations_bulk_form_assignment_source']['action']['#access'] = FALSE;
  ...
  public function viewsFormSubmit(array &$form, FormStateInterface $form_state) {
    ...
    if ($form_state->get('step') === 'views_form_views_form' && $this->view->id() === 'task_assignment_selection_source') {
