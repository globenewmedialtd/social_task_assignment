 ...
 *
 * @ViewsField("social_views_bulk_operations_bulk_form_assignments")
 */
class SocialTaskAssignmentVboViewsBulkOperationsBulkForm extends ViewsBulkOperationsBulkForm {
  ...
  public function getBulkOptions() {
    ...
    if ($this->view->id() !== 'manage_all_task_assignments') {
      return $bulk_options;
    }
    ...
    foreach ($bulk_options as $id => &$label) {
      ...
      $label = $this->t('<b>@action</b> selected assignees', [
        '@action' => $real_label,
      ]);
    }
